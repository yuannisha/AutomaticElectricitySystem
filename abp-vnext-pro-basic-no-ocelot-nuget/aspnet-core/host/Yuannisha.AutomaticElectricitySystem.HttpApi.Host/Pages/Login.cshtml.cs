...
namespace Yuannisha.AutomaticElectricitySystem.Pages
{
    public class Login : PageModel
    {
        ...
        public async Task OnPost()
        {
            ...
            try
            {
                ...
                // 设置cookies domain
                //options.Domain = "AutomaticElectricitySystem.cn";


                var result = await _accountAppService.LoginAsync(new LoginInput()
                { Name = userName, Password = password });
                Response.Cookies.Append(AutomaticElectricitySystemHttpApiHostConst.DefaultCookieName,
