...
#if DEBUG
                .MinimumLevel.Override("Yuannisha.AutomaticElectricitySystem", LogEventLevel.Debug)
#else
                .MinimumLevel.Override("Yuannisha.AutomaticElectricitySystem", LogEventLevel.Information)
#endif
