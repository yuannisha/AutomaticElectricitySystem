namespace Yuannisha.AutomaticElectricitySystem.DbMigrator
{
    public class DbMigratorHostedService : IHostedService
    {
        ...
        {
            using (var application = await AbpApplicationFactory.CreateAsync<AutomaticElectricitySystemDbMigratorModule>(options =>
                   {
                   ...
                   }))
            {
                ...
                await application
                    .ServiceProvider
                    .GetRequiredService<AutomaticElectricitySystemDbMigrationService>()
                    .MigrateAsync();
