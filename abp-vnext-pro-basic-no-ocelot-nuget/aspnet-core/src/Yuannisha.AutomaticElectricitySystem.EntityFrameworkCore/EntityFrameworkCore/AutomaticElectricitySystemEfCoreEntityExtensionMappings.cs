...
{
    public static class AutomaticElectricitySystemEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE AutomaticElectricitySystemModuleExtensionConfigurator CLASS (in the Domain.Shared project)
