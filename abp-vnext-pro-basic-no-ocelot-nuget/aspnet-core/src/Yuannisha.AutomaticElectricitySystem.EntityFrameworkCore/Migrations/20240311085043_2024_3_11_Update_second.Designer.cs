...
namespace Yuannisha.AutomaticElectricitySystem.Migrations
{
    ...
    [Migration("20240311085043_2024_3_11_Update_second")]
    partial class _2024311Updatesecond
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Yuannisha.AutomaticElectricitySystem.BookingInformation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Yuannisha.AutomaticElectricitySystem.BookingLimited", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Yuannisha.AutomaticElectricitySystem.Buildings", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Yuannisha.AutomaticElectricitySystem.PowerSwitchs", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Yuannisha.AutomaticElectricitySystem.Rooms", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Yuannisha.AutomaticElectricitySystem.PowerSwitchs", b =>
                {
                    b.HasOne("Yuannisha.AutomaticElectricitySystem.Rooms", "Room")
            ...
            modelBuilder.Entity("Yuannisha.AutomaticElectricitySystem.Rooms", b =>
                {
                    b.HasOne("Yuannisha.AutomaticElectricitySystem.Buildings", "Building")
                        .WithMany("Rooms")
